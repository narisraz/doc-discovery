...
@riverpod
GetConnectedUserUseCase getConnectedUserUseCase(
        GetConnectedUserUseCaseRef ref) =>
...
@riverpod
GetPractitionerByAuthIdUseCase getPractitionerByAuthIdUseCase(
        GetPractitionerByAuthIdUseCaseRef ref) =>
