...
String _$searchPractitionerUseCaseHash() =>
    r'69ab5b45e086de015d6cbb0a035d8e3e3ddfe05f';

/// See also [searchPractitionerUseCase].
@ProviderFor(searchPractitionerUseCase)
final searchPractitionerUseCaseProvider =
    AutoDisposeProvider<SearchPractitionerUseCase>.internal(
  searchPractitionerUseCase,
  name: r'searchPractitionerUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$searchPractitionerUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
String _$getPractitionerProfileUseCaseHash() =>
    r'457ef484104ab0fe71953300552dab48592ad817';

/// See also [getPractitionerProfileUseCase].
@ProviderFor(getPractitionerProfileUseCase)
final getPractitionerProfileUseCaseProvider =
    AutoDisposeProvider<GetPractitionerProfileUseCase>.internal(
  getPractitionerProfileUseCase,
  name: r'getPractitionerProfileUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getPractitionerProfileUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
